...
// El programa tiene como objetivo crear un proceso hijo utilizando la función fork(), que es parte
// de la biblioteca estándar en sistemas UNIX/Linux.
...
// Ejemplo-3-Correcion", encontrara mas informacion de este codigo.
